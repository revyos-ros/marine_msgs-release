...
Name:           ros-jazzy-marine-acoustic-msgs
Version:        2.1.0
Release:        3%{?dist}%{?release_suffix}
Summary:        ROS marine_acoustic_msgs package
...
%description
The marine_acoustic_msgs package, including messages for common underwater
sensors (DVL, multibeam sonar, imaging sonar)
